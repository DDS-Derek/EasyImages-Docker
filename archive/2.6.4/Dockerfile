...
## docker buildx build -t ddsderek/ddsderek:latest --platform=linux/amd64 G:\桌面\Docker镜像制作\Easyimage\2.6.4 --push
## docker buildx build -t ddsderek/ddsderek:2.6.4 --platform=linux/amd64 G:\桌面\Docker镜像制作\Easyimage\2.6.4 --push
